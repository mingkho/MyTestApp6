...
describe('SecurityRoleEraser', () => {
    const sandbox = (0, sinon_1.createSandbox)();
    const inst = (0, Erasers_1.getEntityEraser)(CommonCrud_1.ErasableType.SecurityRole);
    it('can erase', async () => {
...
//# sourceMappingURL=SecurityRoleEraser.spec.js.map